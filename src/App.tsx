...
function App() {
  return (
    <Container maxWidth="md" sx={{ py: 5, fontFamily: '"Inter", "Helvetica Neue", Arial, sans-serif' }}>
      <Grid container spacing={4}>
        <Grid item xs={12} md={7}>
          <Typography variant="h4" component="h1" sx={{ fontFamily: '"Inter", "Helvetica Neue", Arial, sans-serif', fontWeight: 700 }}>
            Hamed Ajorlou
          </Typography>
          <Typography variant="body1" sx={{ fontFamily: '"Inter", "Helvetica Neue", Arial, sans-serif', color: 'text.secondary' }}>
            Graduate Research Assistant, University of Rochester
          </Typography>

          <Divider sx={{ my: 3 }} />

          <Typography variant="h6" sx={{ fontFamily: '"Inter", "Helvetica Neue", Arial, sans-serif', fontWeight: 700, mb: 1 }}>
            About
          </Typography>
          <Typography variant="body1" sx={{ fontFamily: '"Inter", "Helvetica Neue", Arial, sans-serif', lineHeight: 1.8 }} paragraph>
          ...
          <Typography variant="h6" sx={{ fontFamily: '"Inter", "Helvetica Neue", Arial, sans-serif', fontWeight: 700, mt: 3, mb: 1 }}>
            Research Interests
          </Typography>
          <Typography variant="body1" sx={{ fontFamily: '"Inter", "Helvetica Neue", Arial, sans-serif', lineHeight: 1.8 }}>
      ...
      <Typography variant="h5" sx={{ fontFamily: '"Inter", "Helvetica Neue", Arial, sans-serif', fontWeight: 700, mb: 3 }}>
        News
      </Typography>
      ...
      <Typography variant="body1" sx={{ lineHeight: 1.8, textAlign: 'center', pb: 2 }}>
        <Link href="mailto:hajorlou@ur.rochester.edu" sx={{ color: 'inherit' }}>hajorlou@ur.rochester.edu</Link>
        {' '}&middot;{' '}
        <Link href="https://github.com/hamedajorlou" target="_blank" sx={{ color: 'inherit' }}>GitHub</Link>
        {' '}&middot;{' '}
        <Link href="https://scholar.google.com/citations?user=f8i-0EYAAAAJ&hl=en" target="_blank" sx={{ color: 'inherit' }}>Google Scholar</Link>
      </Typography>
    </Container>
  );
}
