...
function App() {
  return (
    <Container maxWidth="md" sx={{ py: 5, fontFamily: 'serif' }}>
      <Grid container spacing={4}>
        <Grid item xs={12} md={7}>
          <Typography variant="h4" component="h1" sx={{ fontFamily: 'serif', fontWeight: 700 }}>
            Hamed Ajorlou
          </Typography>
          <Typography variant="body1" sx={{ fontFamily: 'serif', color: 'text.secondary' }}>
            Graduate Research Assistant, University of Rochester
          </Typography>

          <Divider sx={{ my: 3 }} />

          <Typography variant="h6" sx={{ fontFamily: 'serif', fontWeight: 700, mb: 1 }}>
            About
          </Typography>
          <Typography variant="body1" sx={{ fontFamily: 'serif', lineHeight: 1.8 }} paragraph>
          ...
          <Typography variant="h6" sx={{ fontFamily: 'serif', fontWeight: 700, mt: 3, mb: 1 }}>
            Research Interests
          </Typography>
          <Typography variant="body1" sx={{ fontFamily: 'serif', lineHeight: 1.8 }}>
      ...
      <Typography variant="h5" sx={{ fontFamily: 'serif', fontWeight: 700, mb: 3 }}>
        News
      </Typography>
